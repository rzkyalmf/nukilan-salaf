...
INSERT INTO "new_VerificationCode" ("code", "createdAt", "id", "lastSentAt", "userId") SELECT "code", "createdAt", "id", coalesce("lastSentAt", CURRENT_TIMESTAMP) AS "lastSentAt", "userId" FROM "VerificationCode";
