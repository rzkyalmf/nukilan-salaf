...
INSERT INTO "new_VerificationCode" ("code", "createdAt", "id", "lastSentAt", "resendCount", "userId") SELECT "code", "createdAt", "id", "lastSentAt", "resendCount", "userId" FROM "VerificationCode";
